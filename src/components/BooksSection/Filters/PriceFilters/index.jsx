    ...
    return (
        <div>
            ...
            <div>
                ...
                <input type="number" name="min" id="min" value={min} onChange={(e) => setMin(e.target.value)} min="1" />
            </div>
            <div>
                <label className="label" htmlFor="max">Máximo R$</label>
                <input type="number" name="max" id="max" value={max} onChange={(e) => setMax(e.target.value)} min="1" />
            </div>
        </div>
    )
}